    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="w-[500px] mx-auto text-center text-6xl">Poem generator</h1>
                <p className="w-[1000px] mx-auto text-center mt-4 text-3xl">Genereaza o poezie pentru cineva drag</p>
